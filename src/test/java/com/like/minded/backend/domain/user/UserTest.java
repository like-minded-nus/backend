...
class UserTest {
    ...
    void equalsVerifiesAllFields() {
        ...
        assertNotEquals(
                user1,
                userDifferent,
                "Users with different field values should not be considered equal.");
    }
    ...
    void hashCodeIsConsistentWithEquals() {
        ...
        assertEquals(
                user1.hashCode(), user2.hashCode(), "Equal users must have the same hash code.");
    ...
    void differentUsersHaveDifferentHashCodes() {
        ...
        assertNotEquals(
                user1.hashCode(),
                userDifferent.hashCode(),
                "Different users ideally have different hash codes.");
    }
}
