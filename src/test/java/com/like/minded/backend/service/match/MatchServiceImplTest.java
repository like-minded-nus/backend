...
class MatchServiceImplTest {
    ...
    @Mock private MatchStrategy matchStrategy;
    ...
    void getProfileMatchesTest() throws Exception {
        ...
        ProfileDto mockProfileDto =
                new ProfileDto(
                        1, 1, "Test", "male", LocalDate.now(), "bio", "", "", "", "", "", "");
        ...
        ResponseEntity<BaseResponse<List<MatchResponseBodyDto>>> response =
                matchService.getProfileMatches(profileId);
    ...
    void createMatchRecordTest() {
        ...
        ResponseEntity<BaseResponse<Match>> response =
                matchService.createMatchRecord(matchRequestBody);
