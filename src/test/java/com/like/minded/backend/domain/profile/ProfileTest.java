...
class ProfileTest {
    ...
    void testProfileCreationAndProperties() {
        ...
        assertEquals(
                ...
                "Display Name should match the provided value");
        assertEquals(gender, profile.getGender(), "Gender should match the provided value");
        assertEquals(
                birthdate, profile.getBirthdate(), "Birthdate should match the provided value");
    ...
    void testEqualsWithSameValues() {
        ...
        assertEquals(
                profile1, profile2, "Profiles with the same values should be considered equal.");
    }
    ...
    void testEqualsWithDifferentValues() {
        ...
        assertNotEquals(
                profile1,
                profile2,
                "Profiles with different values should not be considered equal.");
    }
    ...
    void testEqualsWithNull() {
        ...
        assertNotEquals(
                profile, null, "Profile compared with null should not be considered equal.");
    }
    ...
    void testEqualsWithDifferentType() {
        ...
        assertNotEquals(
                profile,
                notAProfile,
                "Profile compared with a different type should not be considered equal.");
    }
    ...
    void testHashCodeConsistency() {
        ...
        assertEquals(
                hashCode1, hashCode2, "Hash code should remain consistent across invocations.");
    }
