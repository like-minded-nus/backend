...
class PassionTest {
    ...
    void testEqualsWithSameValues() {
        ...
        assertEquals(passion1, passion2, "Passions with the same values should be considered equal.");
    }
    ...
    void testEqualsWithDifferentValues() {
        ...
        assertNotEquals(passion1, passion2, "Passions with different values should not be considered equal.");
    }
    ...
    void testEqualsWithNull() {
        ...
        assertNotEquals(passion, null, "Passion compared with null should not be considered equal.");
    }
    ...
    void testEqualsWithDifferentType() {
        ...
        assertNotEquals(passion, notAPassion, "Passion compared with a different type should not be considered equal.");
    }
    ...
    void testHashCode() {
        ...
        assertEquals(passion1.hashCode(), passion2.hashCode(), "Two passions with the same name must have the same hash code.");

        Passion passionModified = new Passion(null, "Art");

        assertNotEquals(passion1.hashCode(), passionModified.hashCode(), "Two passions with different names are likely to have different hash codes.");
    }
    ...
    void testHashCodeConsistency() {
        ...
        assertEquals(initialHashCode, passion.hashCode(), "Hash code should remain consistent across calls.");
    }
}