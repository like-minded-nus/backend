...
class ActivityTest {
    ...
    void testActivityCreationAndProperties() {
        ...
        assertEquals(
                ...
                "Activity should match the provided value");
        assertEquals(
                activityType,
                activityInstance.getActivityType(),
                "Activity type should match the provided value");
    }
    ...
    void testEquals() {
        ...
        assertNotEquals(
                activity1,
                activityDifferent,
                "Activities with different values should not be equal.");
    }
    ...
    void testHashCode() {
        ...
        assertEquals(
                activity1.hashCode(),
                activity2.hashCode(),
                "Equal activities must have the same hash code.");
        assertNotEquals(
                activity1.hashCode(),
                activityDifferent.hashCode(),
                "Different activities should have different hash codes.");
    }
}
